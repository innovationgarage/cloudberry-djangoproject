# Generated by Django 2.0.3 on 2018-03-15 11:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cloudberry_app_taggedtemplate_tagged_items', to='contenttypes.ContentType', verbose_name='Content type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cloudberry_app.Config')),
                ('vpn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cloudberry_app.Vpn')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='template',
            name='tags',
            field=taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of template tags, may be used to ease auto configuration with specific settings (eg: 4G, mesh, WDS, VPN, ecc.)', through='cloudberry_app.TaggedTemplate', to='cloudberry_app.TemplateTag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='template',
            name='vpn',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cloudberry_app.Vpn', verbose_name='VPN'),
        ),
        migrations.AddField(
            model_name='taggedtemplate',
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cloudberry_app_taggedtemplate_items', to='cloudberry_app.TemplateTag'),
        ),
        migrations.AddField(
            model_name='config',
            name='device',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cloudberry_app.Device'),
        ),
        migrations.AddField(
            model_name='config',
            name='templates',
            field=sortedm2m.fields.SortedManyToManyField(blank=True, help_text='configuration templates, applied from first to last', related_name='config_relations', to='cloudberry_app.Template', verbose_name='templates'),
        ),
        migrations.AddField(
            model_name='config',
            name='vpn',
            field=models.ManyToManyField(blank=True, related_name='vpn_relations', through='cloudberry_app.VpnClient', to='cloudberry_app.Vpn'),
        ),

# from https://github.com/int-ua/django-import-export/blob/cli-import/import_export/management/commands/import_file.py
# Written by https://github.com/int-ua
# Same license as django-import-export (BSD)
